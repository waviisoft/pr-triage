...
// Message-square icon from Feather (MIT) — used for the "Feedback" link.
export function IconFeedback({ size = 13 }: { size?: number }) {
  return (
    <svg width={size} height={size} {...base}>
...
// The GitHub mark (official Octocat glyph). Solid/filled, so it ignores the
// stroke-based `base` and fills with currentColor.
